...
func (c *Client) Mutate(ctx context.Context, m interface{}, input githubv4.Input, variables map[string]interface{}) error {
	if variables == nil {
...
func (c *Client) Copy() *Client {
	return NewEnterpriseClient(c.url, c.httpClient)
}

func (c *Client) WithClient(httpClient *http.Client) *Client {
	return NewEnterpriseClient(c.url, httpClient)
}

func (c *Client) WithURL(url string) *Client {
	return NewEnterpriseClient(url, c.httpClient)
}
